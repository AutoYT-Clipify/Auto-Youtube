    ...
    return (
        <>
            <div style={{ cursor: 'auto', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', fontFamily: 'Gelion, Helvetica, "Helvetica Neue", Arial', lineHeight: '21px', fontSize: '14px', color: 'rgb(3, 3, 3)', fontVariantLigatures: 'no-common-ligatures', letterSpacing: '-0.1px', backgroundColor: 'rgb(242, 242, 242)', height: '707.2px', margin: '0px' }}><noscript style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                    ...
                    <div style={{ height: '707.2px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                        <div style={{ display: 'flex', flexDirection: 'row', height: '707.2px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                            <div style={{ minWidth: '0px', width: '50%', position: 'relative', display: 'flex', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', height: '707.2px', backgroundColor: 'rgb(254, 254, 254)', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                ...
                                <div style={{ maxWidth: 'calc(100% - 100px)', width: '400px', margin: '0px auto', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                    <div style={{ fontWeight: 500, backgroundColor: 'rgb(232, 232, 232)', height: '1px', margin: '32px 0px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}></div>
                                    <form style={{ width: '100%', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                ...
                                <div style={{ display: 'flex', height: '707.2px', position: 'relative', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'justify', justifyContent: 'space-between', padding: '150px 0px 100px', overflow: 'hidden', background: 'rgba(0, 0, 0, 0) url("/signin-bg.jpg")', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                    ...
                                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'justify', justifyContent: 'space-between', width: '520px', maxWidth: 'calc(100% - 100px)', margin: '20px 0px 74px', background: 'rgba(255, 255, 255, 0.5) none repeat scroll 0% 0% / auto padding-box border-box', border: '0.8px solid rgb(255, 255, 255)', borderRadius: '24px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                        <div style={{ display: 'flex', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}><img src="/man.png" alt="avatar" style={{ position: 'relative', display: 'block', width: '60px', height: '60px', margin: '30px auto 0px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', borderStyle: 'none' }} />
                                            <div style={{ display: 'flex', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'start', justifyContent: 'flex-start', textAlign: 'center', margin: '15px 30px 66px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                                <div style={{ margin: '0px', fontSize: '18px', lineHeight: '22px', textAlign: 'center', fontWeight: 500, color: 'rgb(3, 3, 3)', textTransform: 'none', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>“Since I started using this platform, my channel has seen exponential growth. It's like having a virtual assistant that optimizes my content and engages with my audience. A must-have for serious creators”</div>
                                            </div>
                                        </div>
                                        <div style={{ display: 'block', position: 'absolute', bottom: '-54px', left: '274.75px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                            <div style={{ position: 'absolute', top: '-24.35px', left: '-14.675px', width: '36px', height: '36px', backgroundImage: 'url("https://app.uizard.io/static/media/Cursor.dcbbd2226fb2026401ebe63617bb76f4.svg")', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}></div>
                                            <div style={{ display: 'flex', flexFlow: 'column nowrap', WebkitBoxPack: 'center', justifyContent: 'center', alignItems: 'flex-start', borderRadius: '14px', backgroundColor: 'rgb(255, 139, 3)', color: 'rgb(255, 255, 255)', height: '84px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                                                <div style={{ margin: '12px 16px 0px', fontSize: '16px', lineHeight: '20px', letterSpacing: '-0.1px', textAlign: 'start', fontWeight: 400, color: 'rgb(255, 255, 255)', textTransform: 'none', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>Nkosinathi Temba,</div>
                                                <div style={{ margin: '0px 16px', fontSize: '16px', lineHeight: '20px', letterSpacing: '-0.1px', textAlign: 'start', fontWeight: 400, color: 'rgb(255, 255, 255)', textTransform: 'none', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>Founder,</div>
                                                <div style={{ margin: '0px 16px 12px', fontSize: '16px', lineHeight: '20px', letterSpacing: '-0.1px', textAlign: 'start', fontWeight: 400, color: 'rgb(255, 255, 255)', textTransform: 'none', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>Thutos</div>
                                            </div>
                                        </div>
                                    </div><span style={{ display: 'block', maxWidth: '400px', textAlign: 'center', margin: '16px 16px 0px', boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}>
                ...
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 2 }}>
                   
                </div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 8 }}></div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 3 }}></div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 4 }}></div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 5 }}>
                    <div style={{ position: 'fixed', display: 'flex', flexDirection: 'column', WebkitBoxAlign: 'center', alignItems: 'center', WebkitBoxPack: 'center', justifyContent: 'center', bottom: '10px', left: '768px', transform: 'matrix(1, 0, 0, 1, -160, 0)', width: '32rem', maxWidth: 'calc(100% - 40px)', zIndex: 11, boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}></div>
                </div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}></div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 6 }}></div>
                <div style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased', position: 'relative', zIndex: 7 }}></div> <noscript style={{ boxSizing: 'border-box', textRendering: 'optimizelegibility', WebkitFontSmoothing: 'antialiased' }}><img height="1" width="1" style={{ display: 'none' }} src="https://www.facebook.com/tr?id=302191347266077&amp;ev=PageView&amp;noscript=1" /></noscript>
            </div>
        </>
    )
}
